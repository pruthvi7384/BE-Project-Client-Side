    ...
    return (
      <div id="Patient2">
        <div className="heading">
          <h4> Please check all the statement below that applies you</h4>
          <p> Select one answer in each row </p>
        </div>
        <div className="radioButtonDiv">
          <h5>I am overweight</h5>
        ...
        <div className="radioButtonDiv">
          <h5>I have been recently injured</h5>
          <form className="usa-form FormElement">
            <div className="usa-radio margin-x-1">
              <input
