    ...
    return (
        <Container className="symtoms_checker mt-4">
              <Row id="symtoms_checker_heading">
                  ...
                  <p>Checke Your Disease Possible Cases Now !</p>
              </Row>
              <Row className="mt-2">
                <Col xl={2}>
                  ...
                  <Col xl={12}>
                    <Button 
                      style={{ backgroundColor: '#008aff',
                        ...
                        fontWeight:'500'}}
                    disabled={this.state.current_page === "Home"} onClick={this.get_previous_page} className="usa-button usa-button--outline back">
                      Back
                    </Button>
                    {" "}
