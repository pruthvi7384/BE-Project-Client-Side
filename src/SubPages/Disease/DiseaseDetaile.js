    ...
    return (
        ...
        <Container className="disease_page">
            <Row className="disease_heading">
                <h3>Disease <span> {diseaseinfo.desease_name}</span></h3>
                <p>Disease <span> {diseaseinfo.desease_name} </span> Information</p>
            </Row>
            <Row className="disease_info">
                <Col xl={6}>
                    <img className="disease_image" src={diseaseinfo.detail.image ? `${diseaseinfo.detail.image}` : "https://sahyadrihospital.com/wp-content/uploads/2021/04/Be-aware-of-malaria-the-deadly-disease.jpg"} alt="" />
                </Col>
                <Col xl={6}>
